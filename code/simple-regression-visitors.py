...
"""
This file runs a simple regression model using existing visitor count
from 2012 to 2018 and predicts the visitor count for 2019 and 2020. 
"""
...
with open('../data/park-visitors-by-year.csv') as csv_file:
...
outputData = []
outputData.append(["park", "year", "visitors"])
for row in data[1:]:
    p = row[0]
...
with open('../model/park-visitors-by-year-prediction-simple-regression.csv', 'w') as writeFile:
